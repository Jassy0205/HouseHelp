...
Route::post('/v1/customers/register', [App\Http\Controllers\api\v1\AuthController::class, 'registerCustomer'])->name('api.creation_customer');
Route::post('/v1/suppliers/register', [App\Http\Controllers\api\v1\AuthController::class, 'registerSupplier'])->name('api.creation_supplier');
Route::post('/v1/administrators/register', [App\Http\Controllers\api\v1\AuthController::class, 'registerAdministrator'])->name('api.creation_administrator');
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::singleton('/v1/locations', App\Http\Controllers\api\v1\LocationController::class);
    Route::post('/v1/locations', [App\Http\Controllers\api\v1\LocationController::class, 'store'])->name('api.creation_location');
    ...
    Route::middleware('checkCustomerIdentifier')->group(function () {
        ...
        Route::singleton('/v1/customers/profile', App\Http\Controllers\api\v1\CustomerController::class);//->name('api.customer.profile');
    ...
    Route::middleware('checkSupplierIdentifier')->group(function () {
        ...
        Route::singleton('/v1/suppliers/profile', App\Http\Controllers\api\v1\SupplierController::class);
    ...
    Route::middleware(['checkAdminIdentifier'])->group(function () {
        ...
        Route::put('/v1/suppliers/{id}', [App\Http\Controllers\api\v1\SupplierController::class, 'checkAndSuspendSupplier'])->name('api.suppliers.suspend');
        ...
        Route::put('v1/customers/{id}', [App\Http\Controllers\api\v1\CustomerController::class, 'verifyCustomer'])->name('api.customers.verification');
    });
